<template>
  <div class="admin-dashboard">
      ...
      <div class="sidebar-menu">
        <ul class="nav flex-column">
          <li class="nav-item" v-for="(item, index) in menuItems" :key="index">
            <a class="nav-link" :class="{ active: activeMenuItem === item.id }" href="#"
              ...
              <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                  <div class="chart-container" style="height: 300px;">
                    ...
                    <div
                      class="chart-placeholder d-flex align-items-center justify-content-center h-100 bg-light rounded">
              ...
              <ul class="nav nav-tabs" id="settingsTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="security-tab" data-bs-toggle="tab" data-bs-target="#security"
                    type="button" role="tab" aria-controls="security" aria-selected="false">Segurança</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="notifications-tab" data-bs-toggle="tab" data-bs-target="#notifications"
                    type="button" role="tab" aria-controls="notifications" aria-selected="false">Notificações</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="payment-tab" data-bs-toggle="tab" data-bs-target="#payment" type="button"
                    role="tab" aria-controls="payment" aria-selected="false">Pagamentos</button>
                </li>
              </ul>
                  ...
                  <form>
                    ...
                    <div class="mb-3">
                      ...
                      <textarea class="form-control" id="siteDescription"
                        rows="3">A melhor plataforma para encontrar e promover eventos no Brasil.</textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="input-group mb-2">
                        ...
                        <input type="text" class="form-control" placeholder="URL do Facebook"
                          value="https://facebook.com/conectaeventos">
                      </div>
                      <div class="input-group mb-2">
                        <span class="input-group-text"><i class="bi bi-instagram"></i></span>
                        <input type="text" class="form-control" placeholder="URL do Instagram"
                          value="https://instagram.com/conectaeventos">
                      </div>
                      <div class="input-group mb-2">
                        <span class="input-group-text"><i class="bi bi-twitter"></i></span>
                        <input type="text" class="form-control" placeholder="URL do Twitter"
                          value="https://twitter.com/conectaeventos">
                      </div>
                    </div>
                  ...
                  <form>
                    ...
                    <div class="mb-4">
                      ...
                      <select class="form-select" id="passwordPolicy">
                        ...
                        <option value="very-strong">Muito forte (mínimo 12 caracteres, maiúsculas, minúsculas, números e
                          símbolos)</option>
                      </select>
                    </div>
                    <button type="submit" class="btn btn-primary">Salvar Alterações</button>
    ...
    <div class="modal fade" id="deleteEventModal" tabindex="-1" aria-labelledby="deleteEventModalLabel"
      aria-hidden="true" v-if="showDeleteEventModal">
